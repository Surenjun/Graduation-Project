...
// 创建详细数据图
        function createDetail(masterChart) {
            ...
            detailChart = Highcharts.chart(detailContainer, {
                ...
                subtitle: {
                    text: '采集淘宝、天猫、京东、苏宁、国美、一号店、亚马逊、当当、聚美等电商平台数据综合计算'
                },
                xAxis: {
                    type: 'datetime'
                },
                ...
                tooltip: {
                    formatter: function () {
                        ...
                        return '<b>' + point.series.name + '</b><br/>' +
                            ...
                            '当天指数为' + Highcharts.numberFormat(point.y, 2);
                    },
                    shared: true
                },
                legend: {
...
// 创建导航图
    ...
    render() {
        ...
        return (
            <div id="container" style={{minWidth:"400px",height:"400px",position:"relative",marginTop:'50px',backgroundColor: 'rgb(245, 245, 245)'}}>
